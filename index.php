    ...
    <section id="team" class="section-padding">
        <div class="container">
            <div class="row">
                <div class="col-12 text-center" data-aos="fade-down" data-aos-delay="150">
                    <div class="section-title">
                        <h1 class="display-4 fw-semibold">Management Board</h1>
                        <div class="line"></div>
                        <p>Empowering Leadership: Meet Our Management Board</p>
                    </div>
                </div>
            </div>
            <!-- baris pertama -->
            ...
            <div class="row">
                <div class="col-12 text-center" data-aos="fade-down" data-aos-delay="150">
                    <div class="section-title">
                        ...
                        <div class="line"></div>
                        <p>Stay up-to-date with the latest happenings in the world of academia through our University
                            News and Articles section.</p>
                    </div>
                </div>
            </div>
            <div class="row">
            ...
            <div class="row">
                <div class="col-12 text-center" data-aos="fade-down" data-aos-delay="150">
                    <div class="section-title">
                        ...
                        <p class="text-white">Contact Us and Share Your Feedback, Questions, or Comments</p>
                    </div>
                </div>
            </div>
